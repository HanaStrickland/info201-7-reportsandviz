...
# This section will include visualizations illustrating the
# technical experience for several programming concepts among survey respondents

cli_experience_plot_2 <- ggplot(data = survey_data) +
  geom_point(mapping = aes(x = cli_exp, y = programming_exp)) +
  geom_smooth(mapping = aes(x = cli_exp, y = programming_exp), color = "red") +
